...
features = 784
classes = 10
h1 = input('Αριθμός κόμβων στο κρυφό επίπεδο 1: ')
h_2 = input('Αριθμος κόμβων στο κρυφό επίπεδο 2: ')
...
loss_sum = 0
acc_sum = 0
f_ce = "./logs/A2/Extra_Layer/INPUT_results_CE_%s-%s.txt" % (h1, h_2)
f_mse = "./logs/A2/Extra_Layer/INPUT_results_MSE_%s-%s.txt" % (h1, h_2)
...
# Save locally
directories.filecheck('./plots/A2/Extra_Layer/INPUT_{}.png'.format(title1))
directories.filecheck('./plots/A2/Extra_Layer/INPUT_{}.png'.format(title2))
plot_loss.savefig("./plots/A2/Extra_Layer/INPUT_{}.png".format(title2), format='png')
plot_acc.savefig("./plots/A2/Extra_Layer/INPUT_{}.png".format(title1), format='png')
