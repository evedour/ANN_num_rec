...
def a5():
    ...
    print(f'Μοντέλο CNN με ένα επίπεδο 32 φίλτρων {fl}x{fl}, 2x2 MaxPooling, 20% dropout και MLP 128:10')
    # model
    model = Sequential()
    ...
    fname = './logs/A5/32({},{})_0.2_{}-10_DROPOUT.txt'.format(fl, fl, nodes)
    ...
    title1 = 'Validation Accuracy, CNN 32({},{}), max pooling and 20% dropout, {}-10'.format(fl, fl, nodes)
    ...
    title2 = 'Loss, CNN 32({},{}), max pooling and 20% dropout, {}-10'.format(fl, fl, nodes)
