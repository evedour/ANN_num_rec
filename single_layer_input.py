...
features = 784
classes = 10
h_1 = input('Αριθμός κόμβων στο κρυφό επίπεδο 1: ')
...
# Save locally
directories.filecheck('./plots/A2/Single_Layer/INPUT_{}.png'.format(title1))
directories.filecheck('./plots/A2/Single_Layer/INPUT_{}.png'.format(title2))
plot_acc.savefig('./plots/A2/Single_Layer/INPUT_{}.png'.format(title1), format='png')
plot_loss.savefig('./plots/A2/Single_Layer/INPUT_{}.png'.format(title2), format='png')
